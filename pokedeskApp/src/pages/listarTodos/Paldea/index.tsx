    ...
    async function fetchPokemons() {
      try {
        ...
        const res = await fetch(
          `https://pokeapi.co/api/v2/pokemon?limit=1025&offset=905`
        );
    ...
    <>
      ...
      <ScrollView>
        <View style={styles.Lista}>
            ...
            <TouchableOpacity onPress={() => navigator.navigate("Paldea" as never)}><Lista regiao="Paldea" cor="rgba(106, 27, 154, 1)" /></TouchableOpacity>
          </View>
