    ...
    async function fetchPokemons() {
      try {
        ...
        const res = await fetch(
          `https://pokeapi.co/api/v2/pokemon?limit=251&offset=151`
        );
    ...
    <>
      ...
      <ScrollView>
        <View style={styles.Lista}>
            ...
            <TouchableOpacity onPress={() => navigator.navigate("Johto" as never)}><Lista regiao="Johto" cor="rgba(166, 124, 0, 1)" /></TouchableOpacity>
