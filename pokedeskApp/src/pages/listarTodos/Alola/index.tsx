    ...
    async function fetchPokemons() {
      try {
        ...
        const res = await fetch(
          `https://pokeapi.co/api/v2/pokemon?limit=809&offset=721`
        );
    ...
    <>
      ...
      <ScrollView>
        <View style={styles.Lista}>
            ...
            <TouchableOpacity onPress={() => navigator.navigate("Alola" as never)}><Lista regiao="Alola" cor="rgba(239, 108, 0, 1)" /></TouchableOpacity>
