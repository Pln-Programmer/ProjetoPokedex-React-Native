    ...
    async function fetchPokemons() {
      try {
        ...
        const res = await fetch(
          `https://pokeapi.co/api/v2/pokemon?limit=905&offset=809`
        );
    ...
    <>
      ...
      <ScrollView>
        <View style={styles.Lista}>
            ...
            <TouchableOpacity onPress={() => navigator.navigate("Galar" as never)}><Lista regiao="Galar" cor="rgba(183, 28, 28, 1)" /></TouchableOpacity>
